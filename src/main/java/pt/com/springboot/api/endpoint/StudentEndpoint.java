...
public class StudentEndpoint {
    ...
    @GetMapping(path = "admin/studentsASC")
    @ApiOperation(value = "Return a list with all students", response = Student[].class)
    public ResponseEntity<?> listAllASC(Pageable pageable) {
        return new ResponseEntity<>(studentDAO.findAll(pageable), HttpStatus.OK);
    }
    ...
    @GetMapping(path = "protected/students/findByEmail/{email}")
    public ResponseEntity<?> findStudentsByEmail(@PathVariable String email){
        return new ResponseEntity<>(studentDAO.findByEmailIgnoreCaseContaining(email), HttpStatus.OK);
    }
